 ...
 * @author wiemj
 */
public class AfficherAllProduitController implements Initializable {
    ...
    private void initAnnoncePage(int i) {
        ...
        if (TroisAnnonces.size() >= 3) {
            System.out.println("aaa" + TroisAnnonces.get(2).getPrixProduit());
    ...
    public void supprimer(ActionEvent event) throws IOException {
        ...
        AnchorPane parentContent = loader.getRoot();
         AnchorPane window = (AnchorPane) paginator.getParent().getParent();
 ...
 try {
    ...
    public void CommanderProduit(ActionEvent event) throws IOException {
        ...
        AnchorPane parentContent = loader.getRoot();
         AnchorPane window = (AnchorPane) paginator.getParent().getParent();
        CommanderController cont = loader.getController();
    ...
    private void restaurant(ActionEvent event) {
        ...
        liste = new ArrayList<>(produitservice.findAllFiltrer("restaurant"));
